...
//        renderCrossHair(window);
    ...
    private void setupParticlesShader() throws Exception {
        ...
        particlesShaderProgram.createVertexShader(Utils.loadResource("/shaders/particles_vertex.vsh"));
        particlesShaderProgram.createFragmentShader(Utils.loadResource("/shaders/particles_fragment.fsh"));
    ...
    private void setupSkyBoxShader() throws Exception {
        ...
        skyBoxShaderProgram.createVertexShader(Utils.loadResource("/shaders/sb_vertex.vsh"));
        skyBoxShaderProgram.createFragmentShader(Utils.loadResource("/shaders/sb_fragment.fsh"));
    ...
    private void setupSceneShader() throws Exception {
        ...
        sceneShaderProgram.createVertexShader(Utils.loadResource("/shaders/scene_vertex.vsh"));
        sceneShaderProgram.createFragmentShader(Utils.loadResource("/shaders/scene_fragment.fsh"));
